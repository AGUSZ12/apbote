...
const  BotName  =  'APBOT';
const     instagram     =     'axfc_ap';
const       aktif       =       'Kapan bot aktif' ;
const   vcard   =   'BEGIN: VCARD \ n'   // metadata dari kartu kontak
            +     'VERSI: 3.0 \ n' 
            +        'FN: Agus \ n'        // Nama kamu
            +            'ORG: VVIPINDO; \ n '            // Nama bot
            +                       'TEL; ketik = SEL; ketik = SUARA; waid = 62896943543843: +62896943543849 \ n '                       // Nomor whatsapp kamu
            +                'SELESAI: VCARD'
const
{
WAConnection,
